    ...
    Scaffold(topBar = {
        ...
        Column {
            Button(onClick = { /*TODO*/ },
                ...
                Icon(painter= painterResource(R.drawable.outline_storage_24), contentDescription = "Repository")
            ...
            Button(onClick = { /*TODO*/ },
                modifier=Modifier.fillMaxWidth(),
                colors=ButtonDefaults.buttonColors(backgroundColor = Color.White)) {
                Icon(painter= painterResource(R.drawable.ic_pull_request), modifier = Modifier.size(24.dp), contentDescription = "Repository")
                Spacer(modifier = Modifier.width(12.dp))
